...
export const country_list = [
    ...
    { code: "AX", name: "Åland Islands", phone: 358 },
    { code: "AL", name: "Albania", phone: 355 },
    { code: "DZ", name: "Algeria", phone: 213 },
    { code: "AS", name: "American Samoa", phone: 1 },
    ...
    { code: "AG", name: "Antigua and Barbuda", phone: 1 },
    ...
    { code: "KY", name: "Cayman Islands", phone: 1 },
    ...
    { code: "HM", name: "Heard Island and Mcdonald Islands", phone: 61 },
    ...
    { code: "KP", name: "Korea, North", phone: 850 },
    { code: "KR", name: "Korea, South", phone: 82 },
    ...
    { code: "MK", name: "Macedonia North", phone: 389 },
    ...
    { code: "MP", name: "Northern Mariana Islands", phone: 1 },
    ...
    { code: "PN", name: "Pitcairn Islands", phone: 64 },
    ...
    { code: "KN", name: "Saint Kitts and Nevis", phone: 1 },
    { code: "LC", name: "Saint Lucia", phone: 1 },
    { code: "MF", name: "Saint Martin", phone: 590 },
    { code: "PM", name: "Saint Pierre and Miquelon", phone: 508 },
    { code: "VC", name: "Saint Vincent and the Grenadines", phone: 1 },
    ...
    { code: "SX", name: "Sint Maarten", phone: 1 },
    ...
    { code: "TT", name: "Trinidad and Tobago", phone: 1 },
    { code: "TN", name: "Tunisia", phone: 216 },
    { code: "TR", name: "Turkey (Türkiye)", phone: 90 },
    { code: "TM", name: "Turkmenistan", phone: 993 },
    { code: "TC", name: "Turks and Caicos Islands", phone: 1 },
    { code: "TV", name: "Tuvalu", phone: 688 },
    { code: "UM", name: "U.S. Outlying Islands", phone: 1 },
    ...
    { code: "VA", name: "Vatican City Holy See", phone: 39 },
    { code: "VE", name: "Venezuela", phone: 58 },
    { code: "VN", name: "Vietnam", phone: 84 },
    { code: "VG", name: "Virgin Islands, British", phone: 1 },
    { code: "VI", name: "Virgin Islands, U.S", phone: 1 },
